...
fn import_ascii_stl<R: BufRead>(reader: R) -> Result<Mesh, StlError> {
    ...
    for line in reader.lines() {
        ...
        if vertices.len() == 3 {
            ...
            mesh.triangles.push(Triangle { v1, v2, v3, normal });
            vertices.clear();
        }
    }
...
pub fn export_stl<P: AsRef<Path>>(mesh: &Mesh, path: P) -> Result<(), StlError> {
    ...
    for tri in &mesh.triangles {
        writeln!(writer, "  facet normal {} {} {}", tri.normal.x, tri.normal.y, tri.normal.z)?;
        writeln!(writer, "    outer loop")?;
        writeln!(writer, "      vertex {} {} {}", tri.v1.x, tri.v1.y, tri.v1.z)?;
        writeln!(writer, "      vertex {} {} {}", tri.v2.x, tri.v2.y, tri.v2.z)?;
        writeln!(writer, "      vertex {} {} {}", tri.v3.x, tri.v3.y, tri.v3.z)?;
